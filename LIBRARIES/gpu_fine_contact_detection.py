...
def Contact_detection_GPU(particle_A_center_of_mass,particle_B_center_of_mass,particle_A_vertices,particle_B_vertices,particle_A_velocity,particle_B_velocity,particle_A_numvertices,particle_B_numvertices,particle_A_id,particle_B_id,Ks,Kd,mu,force,num_vertices_max):
	...
	force,tempi = gpu_contact_detection(calc_func, particle_A_center_of_mass,particle_B_center_of_mass,particle_A_vertices,particle_B_vertices,particle_A_velocity,particle_B_velocity,particle_A_numvertices,particle_B_numvertices,particle_A_id,particle_B_id,force)
	print(tempi)
	sys.exit(0)


    #for i in range(0,len(particle_A_center_of_mass)):particle_A_numvertices
